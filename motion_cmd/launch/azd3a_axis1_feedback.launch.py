"""Launch the AZD3A Axis 1 feedback-only EtherCAT hardware test."""
...
def generate_launch_description() -> LaunchDescription:
    ...
    xacro_file = package_share / "urdf" / "azd3a_axis1_feedback.urdf.xacro"
    controllers_file = (
        package_share / "config" / "azd3a_axis1_feedback_controllers.yaml"
    )
    robot_description = {
